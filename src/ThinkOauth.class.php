...
abstract class ThinkOauth
{
    ...
    public function __construct($token = null)
    {
        ...
        $config = BoxModel('system_addons')->where(array('name' => 'SyncLogin'))->find();
    ...
    {
        $addons_url = addons_url('SyncLogin/Base/callback');
        $this->Callback = LoginUrl . $addons_url . "/?type=" . strtolower($this->Type) . "&backUrl=" . I('backUrl');
        //dump($this->Callback);exit();
        /*$config = C("THINK_SDK_{$this->Type}");
